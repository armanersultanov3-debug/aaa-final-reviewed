...
_EXTERNAL_RULE_METAS = [
    ...
    RuleMeta(rule_id="external.referrer_policy_missing", title="Referrer-Policy header missing", severity="info", description="Referrer-Policy header missing.", recommendation="Add a Referrer-Policy header.", category="external", input_kind="probe", order=650),
    RuleMeta(rule_id="external.referrer_policy_unsafe", title="Unsafe Referrer-Policy value", severity="low", description="Unsafe Referrer-Policy value.", recommendation="Use a restrictive Referrer-Policy.", category="external", input_kind="probe", order=651),
    RuleMeta(rule_id="external.permissions_policy_missing", title="Permissions-Policy header missing", severity="info", description="Permissions-Policy header missing.", recommendation="Add a Permissions-Policy header.", category="external", input_kind="probe", order=652),
    RuleMeta(rule_id="external.coep_missing", title="Cross-Origin-Embedder-Policy header missing", severity="info", description="Cross-Origin-Embedder-Policy header missing.", recommendation="Add a COEP header.", category="external", input_kind="probe", order=653),
    RuleMeta(rule_id="external.coop_missing", title="Cross-Origin-Opener-Policy header missing", severity="info", description="Cross-Origin-Opener-Policy header missing.", recommendation="Add a COOP header.", category="external", input_kind="probe", order=654),
    RuleMeta(rule_id="external.corp_missing", title="Cross-Origin-Resource-Policy header missing", severity="info", description="Cross-Origin-Resource-Policy header missing.", recommendation="Add a CORP header.", category="external", input_kind="probe", order=655),
    # -- _https.py --
