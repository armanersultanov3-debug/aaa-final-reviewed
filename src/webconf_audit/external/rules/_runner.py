...
_EXTERNAL_RULE_METAS = [
    ...
    RuleMeta(rule_id="external.iis.default_welcome_page", title="Default IIS welcome page exposed", severity="medium", description="Default IIS welcome page exposed", recommendation="Replace or remove the default IIS welcome page.", category="external", input_kind="probe", condition="iis", order=607),
    ...
    RuleMeta(rule_id="external.lighttpd.default_welcome_page", title="Default lighttpd welcome page exposed", severity="medium", description="Default lighttpd welcome page exposed", recommendation="Replace or remove the default lighttpd welcome page.", category="external", input_kind="probe", condition="lighttpd", order=609),
    # -- _cookies.py --
