...
Каждое правило обязано иметь `standards=` как минимум CWE + OWASP Top 10
...
Причина: текущая `LighttpdCondition` ([parser.py](src/webconf_audit/local/lighttpd/parser/parser.py), строки 14-18)
