...
| `external.dockerfile_exposed` | `/Dockerfile` | low | директивы `FROM ` + одно из `RUN`/`COPY`/`CMD` |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `docs: sync after 2026-05-14 review` | 4 расхождения Codex + HTTP/3 rationale (O-04) + ECH triger (O-04) + downgrade 9 stds (O-06) + убрать STD-GAP-033 из active backlog (O-02) | S | 0 | ~1 час |
