...
The current project inventory is 468 rules (synchronized with
...
- Registry and documentation counters are synchronized at 468 rules:
  Universal 14, Nginx 95, Apache 87, Lighttpd 50, IIS 53, External 169.
