...
- [x] IIS local rules (51) — CWE/OWASP/ASVS filled; CIS existing-rule reference
  pass complete
- [x] External (probe) rules (83) — CWE/OWASP filled; selected runtime-evidence
