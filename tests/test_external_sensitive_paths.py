...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("/openapi.json", "external.openapi_spec_exposed"),
        ("/swagger.json", "external.openapi_spec_exposed"),
        ("/swagger/v1/swagger.json", "external.openapi_spec_exposed"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("/openapi.json", "external.openapi_spec_exposed", "application/json", '{"info":{"title":"Example API"}}'),
        ("/swagger.json", "external.openapi_spec_exposed", "application/json", '{"info":{"title":"Example API"}}'),
        ("/swagger/v1/swagger.json", "external.openapi_spec_exposed", "application/json", '{"info":{"title":"Example API"}}'),
